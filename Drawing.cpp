...
void Drawing::FillArea ( int x, int y, int w, int h, int r, int g, int b, int a )
{
...
void Drawing::FillArea2 ( int x, int y, int w, int h, int r, int g, int b, int a )
{
	if ( g_Offset.HLType != RENDERTYPE_HARDWARE )
	{
		g_Engine.pfnFillRGBA ( x, y, w, h, r, g, b, a );
...
void Drawing::DrawBox ( int x, int y, int w, int h, int linewidth, int r, int g, int b, int a )
{
...
void Drawing::DrawBox2 ( int x, int y, int w, int h, int linewidth, int r, int g, int b, int a )
{
...
void Drawing::DrawShadowBox ( int x, int y, int w, int h, int r, int g, int b, int a )
{
...
void Drawing::DrawLine ( int x1, int y1, int x2, int y2, int lw, int r, int g, int b )
{
	glDisable ( GL_TEXTURE_2D );
	glEnable ( GL_BLEND );
	glBlendFunc ( GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA );
...
void Drawing::DrawVectorLine ( float *flSrc, float *flDestination, int lw, int r, int g, int b )
{
